...
# -*- coding: utf-8 -*-
"""
mesh_quality_check.py — 基于 PyFluent 的网格质量检查工具
====================================================================
...
用法：
    python mesh_quality_check.py <网格文件路径> [--dim 2|3] [--cores N] [--precision single|double] [--json FILE] [--d]

示例：
    python mesh_quality_check.py test.cas.h5
    python mesh_quality_check.py VM02.msh
    python mesh_quality_check.py PTE.cas.h5 --cores 8 --json result.json
    python mesh_quality_check.py VM02.msh --dim 2
    python mesh_quality_check.py VM02.msh --d        # 仅输出维度：当前网格 / 网格维度：2d
"""
import argparse
import json
import os
